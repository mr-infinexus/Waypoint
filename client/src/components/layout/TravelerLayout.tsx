          ...
          <header className="h-14 border-b border-border/40 px-4 flex items-center justify-between shrink-0 bg-card/40 backdrop-blur-md sticky top-0 z-30">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">
                Waypoint Travel Engine
              </span>
            </div>
          </header>
          <main className={isFullScreenPage ? "flex-1 flex flex-col h-[calc(100vh-4rem)] overflow-hidden" : "flex-1 p-4 sm:p-6 lg:p-8 max-w-7xl w-full mx-auto"}>
